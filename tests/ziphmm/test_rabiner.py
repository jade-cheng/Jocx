...
class TestRabiner(unittest.TestCase):
    ...
    #
    # Rabiner's algorithm cannot compute these test sequences reliably.
    #
    ...
    #     self.__test('test6', 'test6_100000', -104126.2410)
    #
