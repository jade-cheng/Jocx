...
from ziphmm import compute_lle
...
class TestSand(unittest.TestCase):
    ...
    #
    # These also work, and execute quickly, but compressing the long sequences
    # takes significant time so ignore these test sequences.
    #
