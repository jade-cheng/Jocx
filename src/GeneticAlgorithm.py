...
class Individual(object):
    ...
    def __init__(self, genome, fitness):
        ...
        assert type(fitness) in (int, float)
...
class Context(object):
    """
    Context information for the Genetic Algorithm optimiser; this instance is passed to the optional log method and
...
class Optimiser(object):
    ...
    def maximise(self, fitness_function, genome_length):
        """
        ...
        while True:
            ...
            if context.aborted:
                ...
                return context
            if self.max_generations is not None and context.generation >= self.max_generations:
