...
class Context(object):
    """
    Context information for the Differential Evolution optimiser; this instance is passed to the optional log method
    and eventually returned as a result of the optimisation.
    """
